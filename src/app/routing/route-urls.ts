...
const marketplaceRoutes: Routes = [
    ...
    {
        path: 'order-history',
        loadChildren: () => import('../pages/marketplace/order-history/order-history.module').then((m) => m.OrderHistoryModule),
        // resolve: {
        //     routeResolver: ValidateMeta
        // },
        data: {
    ...
    {
        path: 'categories',
        loadChildren: () => import('../pages/marketplace/category/category.module').then((m) => m.CategoryModule),
        // resolve: {
        //     routeResolver: ValidateMeta
        // },
        data: {
